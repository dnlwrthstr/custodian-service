...
async def seed_database():
    ...
    logger.info(f"Inserted {len(custodians_data)} custodians.")
    ...
    logger.info(f"Inserted {len(portfolios_data)} portfolios.")
    ...
    logger.info(f"Inserted {len(accounts_data)} accounts.")
    ...
    logger.info(f"Inserted {len(positions_data)} positions.")
